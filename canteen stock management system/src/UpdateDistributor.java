...
public class UpdateDistributor extends JFrame implements ActionListener
{
    JFrame jf;
	...
	UpdateDistributor()
	{
	    ...
	    l6=new JLabel("Update Distributor");
 ...
 l1.setBounds(150,120,130,25);
  ...
  l5.setBounds(150,280,170,25);
		...
		t5.setBounds(320,280,200,25);t5.setToolTipText("Enter distributor emailid");
		jf.add(t5);


        b0 = new JButton("Open",new ImageIcon("images//open.png"));
	    b0.setBounds(150,330,110,35);b0.setToolTipText("click to open distributor details");
	    jf.add(b0); b0.addActionListener(this);

		b1 = new JButton("Update",new ImageIcon("images//update.png"));
		b1.setBounds(300,330,110,35);b1.setToolTipText("click to update distributor details");
		...
		b3.setBounds(600,330,110,35);b3.setToolTipText("click to view all distributor details");
        ...
        model.addColumn("D_EMAILID");
	     ...
	     jf.setTitle("Update Distributor");
	     jf.setSize(900,700);
...
String str1="UPDATE distributor SET did='"+t1.getText()+"',dname='"+t2.getText()+"',daddress='"+t3.getText()+"',dphoneno='"+t4.getText()+"',demailid='"+t5.getText()+"' where did='"+t1.getText()+"' or dname='"+t2.getText()+"' ";
