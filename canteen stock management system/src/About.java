...
class About extends JFrame
{
	...
	About ()
	{
		...
		l1 = new JLabel("Canteen stock Manangement System");
		...
		l3 = new JLabel("janhavi,neha,samiksha,maheshwari");
		...
		l5 = new JLabel("In this system we can add details of Distributor,Vegetables,Grocery and other material.");
		...
		l7 = new JLabel("It is helpfull for Maintaining stock of canteen.");
