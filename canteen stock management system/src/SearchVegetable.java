...
public class SearchVegetable extends JFrame implements ActionListener
{
    JFrame jf;
    ...
    SearchVegetable()
    {
        ...
        ln=new JLabel("Search Vegetable");
  ...
  l1.setBounds(50,100,200,25);
        ...
        t1.setBounds(250,100,100,25);t1.setToolTipText("Enter Vegetable batch no to search");
        jf.add(t1);
   ...
   l2.setBounds(50,140,200,25);
        ...
        t2.setBounds(250,140,200,25);t2.setToolTipText("Enter Vegetable name to search");
        jf.add(t2);
   ...
   l4.setBounds(50,220,200,25);
        ...
        l5= new JLabel("Vegetable expiry date");
        //l5.setFont(f);
   l5.setBounds(50,260,250,25);
        ...
        l6= new JLabel("Vegetable purchase date");
        //l6.setFont(f);
   ...
   l11.setBounds(470,260,180,25);
     ...
     l12.setBounds(470,300,180,25);
        ...
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to search Vegetable details");
