...
public class GroceryList extends JFrame
 {
  ...
  {
    jf.setLayout(null);
  	ln = new JLabel("Stock Of grocery");
    ...
    model.addColumn("Batchno");model.addColumn("Name");model.addColumn("Company");model.addColumn("Quantity");
  	...
  	model.addColumn("Saleprice");model.addColumn("Rackno");model.addColumn("distributorid");model.addColumn("disrtibutorname");
  		int r = 0;
     try
     {
