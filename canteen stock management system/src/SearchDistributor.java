...
public class SearchDistributor extends JFrame implements ActionListener
{
	JFrame jf;
	...
	SearchDistributor()
	{
	    ...
	    l6=new JLabel("Search Distributor");
   ...
   l1.setBounds(150,120,130,25);
		...
		t1.setBounds(320,120,100,25);t1.setToolTipText("Enter distributor id to search distributor");
		jf.add(t1);
   ...
   l2.setBounds(150,160,170,25);
		...
		t2.setBounds(320,160,200,25);t2.setToolTipText("Enter distributor name to search Distributor");
		jf.add(t2);
   ...
   l5.setBounds(150,280,170,25);
      ...
      model.addColumn("D_EMAILID");
	     ...
	     jf.setTitle("Search Distributor");
	     jf.setSize(900,700);
