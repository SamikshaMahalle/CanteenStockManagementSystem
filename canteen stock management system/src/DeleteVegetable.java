...
public class DeleteVegetable extends JFrame implements ActionListener
{
	JFrame jf;
	...
	DeleteVegetable()
	{
	    ...
	    ln=new JLabel(" Delete Vegetable ");
...
l1.setBounds(50,100,200,25);
		...
		t1.setBounds(250,100,100,25);t1.setToolTipText("Enter vegetable batch no to delete vegeatble");
		jf.add(t1);
  ...
  l2.setBounds(50,140,200,25);
		...
		t2.setBounds(250,140,200,25);t2.setToolTipText("Enter vegetable name to delete vegetable");
		jf.add(t2);
  ...
  l9.setBounds(470,180,200,25);
   ...
   l11.setBounds(470,260,180,25);
       ...
       l12.setBounds(470,300,180,25);
		...
		b1.setBounds(300,330,110,35);b1.setToolTipText("click to delete vegetable details");
    ...
    if(ae.getSource()==b0)
	  {
	  	try
	  	{
	  	 if(((t1.getText()).equals(""))&&((t2.getText()).equals("")))
	        {
		    JOptionPane.showMessageDialog(this,"Please enter vegetable bno or name !","Warning!!!",JOptionPane.WARNING_MESSAGE);
	        }
	        else
	        {
	         int foundrec = 0;
	 ...
	 {//delete
		...
		System.out.println("Connected to database.");
	    ps=con.prepareStatement("delete from vegetable where vbno='"+t1.getText()+"' or vname='"+t2.getText()+"'");
	    ps.executeUpdate();
