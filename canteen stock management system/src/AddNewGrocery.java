...
public class AddNewGrocery extends JFrame implements ActionListener
{
    JFrame jf;
    ...
    AddNewGrocery()
    {
        ...
        ln=new JLabel("New Grocery details");
   ...
   l7.setBounds(470,100,200,25);
        ...
        groctype.setBounds(720,100,100,25);groctype.setToolTipText("Select Grocery type");
        jf.add(groctype);
  ...
  l10.setBounds(470,220,200,25);
    ...
    l11.setBounds(470,260,250,25);
        ...
        gdname.setBounds(720,260,130,25);gdname.setToolTipText("select Grocery distributor name");
        jf.add(gdname);
       ...
       System.out.println(e);
        ...
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to save grocery details");
        ...
        b2.setBounds(450,330,110,35);b2.setToolTipText("click to view all grocery details");
 ...
 ps=con.prepareStatement("insert into grocery (gbno,gname,gcompany,gqty,gexpdate,gpurdate,gtype,gpurprice,gsaleprice,grackno,did,dname)values(?,?,?,?,?,?,?,?,?,?,?,?)");
  ...
  int reply=JOptionPane.showConfirmDialog(null,"Groceryadded successfully.Do you want add more Grocery?","Added Grocery",JOptionPane.YES_NO_OPTION);
