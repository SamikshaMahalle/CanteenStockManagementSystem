...
public class UpdateVegetable extends JFrame implements ActionListener
{
    JFrame jf;
    ...
    UpdateVegetable()
    {
        ...
        ln=new JLabel("Update Vegetable");
  ...
  l1.setBounds(50,100,200,25);
   ...
   l2.setBounds(50,140,200,25);
        ...
        t2.setBounds(250,140,200,25);t2.setToolTipText("Enter vegetablee name");
        jf.add(t2);
  ...
  l7.setBounds(470,100,200,25);
        ...
        t7.setBounds(720,100,100,25);t7.setToolTipText("Enter vegetable type");
        jf.add(t7);
        ...
        vegtype.setBounds(600,100,100,25);vegtype.setToolTipText("Select medicine type");
        jf.add(vegtype);
        ...
        l8= new JLabel("Vegetable purchase price*");
        //l8.setFont(f);
...
l10.setBounds(470,220,200,25);
 ...
 l12.setBounds(470,300,180,25);
        ...
        vdname.setBounds(600,260,110,25);vdname.setToolTipText("select vegetable distributor name");
        jf.add(vdname);
       ...
       System.out.println(e);
        ...
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to open vegetable details");
        jf.add(b0);b0.addActionListener(this);
 
        b1 = new JButton("Update",new ImageIcon("images//update.png"));
        b1.setBounds(300,330,110,35);b1.setToolTipText("click to update vegetable details");
        ...
        b3.setBounds(600,330,110,35);b3.setToolTipText("click to view all vegetable details");
 ...
 public void actionPerformed(ActionEvent ae)
  {
      if(ae.getSource()==b0)
      {
            ...
            {
            JOptionPane.showMessageDialog(this,"Please enter vegetable batchno or name !","Warning!!!",JOptionPane.WARNING_MESSAGE);
            }
            else
            {
        ...
        System.out.println("Connected to database.");
          ...
          ps=con.prepareStatement("select * from vegetable where vname='"+t2.getText()+"' or vbno='"+t1.getText()+"' ");
          rs=ps.executeQuery();
          while(rs.next())
          {
...
String str1="UPDATE vegetable SET vbno='"+t1.getText()+"',vname='"+t2.getText()+"',vcompany='"+t3.getText()+"',vqty='"+t4.getText()+"',vexpdate='"+t5.getText()+"',vpurdate='"+t6.getText()+"',vtype='"+t7.getText()+"',vpurprice='"+t8.getText()+"',vsaleprice='"+t9.getText()+"',vrackno='"+t10.getText()+"',did='"+t12.getText()+"',dname='"+t11.getText()+"' where vbno='"+t1.getText()+"'or vname='"+t2.getText()+"'";
